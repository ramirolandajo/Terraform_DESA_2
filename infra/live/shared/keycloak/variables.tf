variable "aws_region" {
  description = "AWS region where the Keycloak server will be deployed."
  type        = string
}
...
variable "ami" {
  description = "AMI ID for the Keycloak server."
  type        = string
}

variable "instance_type" {
  description = "EC2 instance type for the Keycloak server."
  type        = string
}
...
variable "user_data" {
  description = "User data script to configure Keycloak."
  type        = string
  default     = null
}
